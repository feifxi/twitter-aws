...
type Querier interface {
	...
	CreatePublicRoomMessage(ctx context.Context, arg CreatePublicRoomMessageParams) (PublicRoomMessage, error)
	...
	ListPublicRoomMessages(ctx context.Context, arg ListPublicRoomMessagesParams) ([]PublicRoomMessage, error)
